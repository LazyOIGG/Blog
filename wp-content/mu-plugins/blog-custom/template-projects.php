...
<head>
    ...
    <title><?php echo get_bloginfo("name"); ?> - Projects</title>
    <!-- CSS 模块 -->
        ...
        <div class="mobile-nav-menu" id="mobileNavMenu">
            ...
            <div class="mobile-nav-menu-content">
                ...
                <div class="mobile-nav-section">
                    ...
                    <a href="<?php echo home_url('/?section=projects'); ?>" class="mobile-nav-item active">
        ...
        <nav class="side-nav" id="sidebarNav">
            ...
            <div class="side-nav-menu">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo home_url('/?section=projects'); ?>" class="nav-item active">
                        <div class="nav-icon">
                            <svg viewBox="0 0 24 24">
